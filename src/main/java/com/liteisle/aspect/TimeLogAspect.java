...
public class TimeLogAspect {
     ...
     * '*' 代表任意返回值、类名或方法名
     *
     * 根据你的项目结构，controller都在 com.liteisle.XXX.controller 包下，
     * 所以 "execution(public * com.liteisle..controller..*.*(..))" 是一个精准且通用的表达式。
     */
    @Pointcut("execution(public * com.liteisle..controller..*.*(..))")
